...
urlpatterns = [
  ...
  path('apply/<int:job_id>/<int:candidate_id>/', views.apply_to_job, name='apply_to_job'),
  path('unapply/<int:job_id>/<int:candidate_id>/', views.unapply_from_job, name='unapply_from_job'),
